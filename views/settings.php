...
<table class="form-table" border="0">
	...
	<tr>
		<td><label class="addthis-ssi-field-label">Twitter App Key : </label>
			<br/>
	...
	<tr><td colspan="2"><label class="addthis-ssi-field-label">Yahoo! : </label><input type="checkbox" class="addthis-ssi-checkbox" name="addthis_ssi_yahoo_enabled" id="addthis_ssi_yahoo_enabled" value="1" <?php echo get_option('addthis_ssi_yahoo_enabled') ? 'checked="checked"' : ""; ?>/>&nbsp;<label class="addthis-ssi-field-label"></label></td></tr>
	...
	<td>
			<input name="addthis_ssi_button_text" class="addthis-ssi-field" type="text" id="addthis_ssi_button_text" value="<?php echo get_option('addthis_ssi_button_text'); ?>" style="width:365px"/>
	</td>
	</tr>
	<tr>
	...
	<tr><td colspan="2"><label class="addthis-ssi-instructions">( Force user to fill data instead using sytem generated, if any one is missing. ex:Twitter is not providing email address  )</label></td></tr>
	
	<tr>
		<td colspan="2">
		<input type="hidden" name="action" value="update"/>
		<input type="hidden" name="page_options" value="addthis_ssi_fbid, addthis_ssi_twkey, addthis_ssi_googleid, addthis_ssi_linkedin_key, addthis_ssi_linkedin_secret, addthis_ssi_yahoo_enabled, addthis_default_user_role, addthis_ssi_redirect_url, addthis_ssi_welcome_enabled, addthis_ssi_thumbnail_enabled, addthis_ssi_button_text, addthis_ssi_popup_enabled"/>
